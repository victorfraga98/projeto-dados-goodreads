...
print(ggplot(book_lang, aes(x = book_lang$Language, y = count)) +
             geom_col(color = color1, fill = color2) +
             labs(title = "Linguagem dos livros", subtitle = "Apenas línguas que tenham pelo menos 100 livros publicados", x = "Linguagem", y = "Frequência"))  
...
# número de páginas
print(ggplot(books_selected, aes(x = PagesNumber)) +
             geom_histogram(color = color1, fill = color2) +
             ylim(0,2000000) +
             stat_bin(geom="text", colour = "grey", aes(label = ifelse(..count.. == max(..count..), ..count.., "" )), vjust = -0.4) +
             labs(title = "Quantidade de páginas do livro", subtitle = "Todos os livros, independente da quantidade de páginas", x = "Quantidade de páginas", y = "Frequência"))  
...
for(i in 1:5){
  ...
  switch (i,
    '1' = {intervalo_paginas <- books_estat_descritivas %>%
           ...
           print(ggplot(intervalo_paginas, aes(x = Numero_paginas)) +
                 geom_boxplot(color = color1, fill = color2) + coord_flip() +
                 labs(title = "Quantidade de páginas do livro", subtitle = "Apenas livros que tenham entre 10 e 1000 páginas", x = "Quantidade de páginas", y = "Frequência") +
                 theme(axis.text = element_text(size = 12)))
    },
    '2' = {intervalo_anos <- books_estat_descritivas %>%
           ...
           print(ggplot(intervalo_anos, aes(x = Ano_publicacao)) +
                 geom_boxplot(color = color1, fill = color2) + coord_flip() +
                 labs(title = "Ano de publicação do livro", subtitle = "Apenas livros publicados entre 1950 e 2020", x = "Ano de publicação") +
                 theme(axis.text = element_text(size = 12)))
    },
    ...
    '4' = {min_avaliacoes <- books_estat_descritivas %>%
           ...
           print(ggplot(min_avaliacoes, aes(x = Total_avaliacoes)) +
                 geom_boxplot(color = color1, fill = color2) + coord_flip() +
                 labs(title = "Quantidade total de avaliações por livro", subtitle = "Apenas livros mais do que 100.000 avaliações", x = "Quantidade de avaliações") +
                 theme(axis.text = element_text(size = 12)))
    },
    '5' = {min_resenhas <- books_estat_descritivas %>%
           ...
           print(ggplot(min_resenhas, aes(x = Total_resenhas)) +
                 geom_boxplot(color = color1, fill = color2) + coord_flip() +
                 labs(title = "Quantidade total de resenhas por livro", subtitle = "Apenas livros com mais do que 10.000 resenhas", x = "Quantidade de resenhas") +
                 theme(axis.text = element_text(size = 12)))
    },
...
div(style="font-family: Arial, Times New Roman; color:#0b0b0b; text-align:center",
    ...
    div("Top 10 anos de publicação com melhor avaliação média", style="font-size: 11pt"),
...
ggsave(filename = "imagem.png", width = 8, height = 6, dpi = 140)
```
...
aval_autor_filtrado$id <- seq(1, nrow(data))
